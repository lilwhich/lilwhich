...
一个喜欢造工具、追着 AI 前沿跑的计算机学生：写过 Android App、配过华为云 IoT、有**丰富的 AI Agent 使用与开发经验**——不只是调用，而是研究 Agent **怎么在真实工程里跑起来**：上下文怎么管理、工具怎么编排、成本怎么控制、出错怎么兜底。
